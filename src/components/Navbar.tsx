                          ...
                          <div className="flex items-center p-1 bg-white/5 border border-white/5 rounded-2xl gap-1">
                            {[
                              ...
                              <button
                                ...
                                className={`flex-1 px-3 py-1.5 rounded-xl text-[11px] font-bold transition-all relative ${notifTab === tab.id
              ...
              <div className="flex items-center gap-1 bg-white/5 backdrop-blur-sm px-1.5 py-1.5 rounded-full border border-white/[0.08] -my-1 shadow-[0_0_15px_rgba(255,255,255,0.08),inset_0_1px_1px_rgba(255,255,255,0.12)] relative">
                {NAV_ITEMS.map((item) => (
                  ...
                  >
                    <Link
                      to={item.href}
                      className={`relative px-5 py-2 rounded-full text-sm font-bold uppercase tracking-wide transition-colors duration-300 flex items-center gap-1.5 z-10 ${activeNav === item.id ? 'text-black font-black' : 'text-zinc-400 hover:text-white'
                        }`}
                    ...
                    >
                      ...
                      {item.isDropdown && <ChevronDown size={14} className={`relative z-10 transition-transform duration-300 ${isDropdownOpen ? 'rotate-180' : ''}`} />}
                    </Link>
                          ...
                          <div className="flex items-center p-1 bg-white/5 border border-white/5 rounded-2xl gap-1">
                            {[
                              ...
                              <button
                                ...
                                className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-xl text-[11px] font-bold transition-all ${notifTab === tab.id
                          ...
                          <div className="p-4 flex items-center gap-3 border-b border-white/5">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center justify-between">
                                ...
                                <span className={`text-[8px] px-2 py-0.5 rounded-full border font-black uppercase tracking-wider ${(user?.level && LEVEL_CONFIG[user.level as keyof typeof LEVEL_CONFIG]?.color) || 'bg-blue-500/20 text-blue-400 border-blue-500/20'
                                  }`}>
